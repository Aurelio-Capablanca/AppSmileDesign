...
function readRowsCuenta(api) {
    fetch(api + 'readOneCuentas', {
        method: 'get'
    }).then(function (request) {
        // Se verifica si la petición es correcta, de lo contrario se muestra un mensaje indicando el problema.
        if (request.ok) {
...
function searchRowsCount(api, form) {
    fetch(api + 'searchOneCount', {
        method: 'post',
        body: new FormData(document.getElementById(form))
    }).then(function (request) {
        // Se verifica si la petición es correcta, de lo contrario se muestra un mensaje indicando el problema.
...
function searchRowsDates(api, form) {
    fetch(api + 'searchOneConsultasCantidad', {
        method: 'post',
        body: new FormData(document.getElementById(form))
    }).then(function (request) {
        // Se verifica si la petición es correcta, de lo contrario se muestra un mensaje indicando el problema.
...
function searchOneArchivo(api, form) {
    fetch(api + 'searchOneArchivo', {
        method: 'post',
        body: new FormData(document.getElementById(form))
    }).then(function (request) {
        // Se verifica si la petición es correcta, de lo contrario se muestra un mensaje indicando el problema.
...
function confirmSuspender(api, data) {
    swal({
        title: 'Advertencia',
        text: '¿Desea Suspender el Pago?',
        icon: 'warning',
        buttons: ['No', 'Sí'],
        closeOnClickOutside: false,
        closeOnEsc: false
...
*   Retorno: ninguno.
*/
function DonghutGraph(canvas, legends, values, title) {
    // Se declara un arreglo para guardar códigos de colores en formato hexadecimal.
    let colors = [];
    // Se declara e inicializa una variable para sumar los valores a graficar.
    let total = 0;
